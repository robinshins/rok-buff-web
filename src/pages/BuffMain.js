...
class BuffMain extends Component {
    state = {lasttime:NaN, x: this.props.match.params.x, y: this.props.match.params.y, ischeck0: false, ischeck1: false, ischeck2: false, lostkingdom: false, backgroundColor: '', textcolor: '', titleType: -1, is_kvk: 0, duke_wait: null, scientist_wait: null, architecture_wait: null };
